...
describe('Command Runner Builder', () => {
 ...
 it('can run ls', async () => {
   ...
   const run = await architect.scheduleBuilder('@devkit/command-runner:command', {
     command: 'ls',
     args: [__dirname],
   ...
   // Expect that this file was listed. It should be since wesss're running
   // `ls $__dirname`.
   console.log("list of file directories \n"+logs)
